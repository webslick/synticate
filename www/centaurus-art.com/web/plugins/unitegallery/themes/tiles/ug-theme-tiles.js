...
jQuery(document).ready(function() {
	apiGallery = jQuery("#prod_grid").unitegallery( {		
		gallery_width:"100%",	
		gallery_min_width: 300,	
		tiles_type:"nested",
		tiles_nested_optimal_tile_width:170, // Мин. ширина изображения
		tiles_space_between_cols: 10, //Расстояние между изображениями
		tile_show_link_icon:true,
		tile_enable_textpanel:true,
		tile_min_columns: 2, 		// Мин. кол-во колонок галереи
		tile_link_newpage: false,	// Открытие ссылки в том же окне браузера
		tile_space_between_icons: 26
	}); 

	jQuery('#prod_grid .ug-thumb-wrapper').each(function(i, el) {
