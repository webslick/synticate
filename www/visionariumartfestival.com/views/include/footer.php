...
<!-- 				<a class="donate-btn f-btn" href="/donate">Donate</a> -->
	...
	<!-- For Local pipol -->
	<a class="for-local" href="https://www.hadra.net/tickets/index.php?event_id=17&&lang=2&fbclid=IwAR2MFhGQkQgyyf8JaRT7ZpZO08_dpjZM1cLnAUunPssidDvHPORIjuNMB5Q" target="_blank" onclick="yaCounter51416728.reachGoal ('local_ticket'); return true;">
		Oferta especial - ¡Entrada de 1 día para huéspedes de la provincia de Barcelona, solo 25 euros.
	</a>
	...
	<div id="bg_fixed" class="bg-img-wrap c-page" data-speed="5" data-type="background">
		...
		<!-- <img class="main-bg-small" src="/img/bg-full-small.jpg" alt="Visionarium"> -->
	</div>
